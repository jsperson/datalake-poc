...
outputfile4 = glueContext.write_dynamic_frame.from_options(frame = selectfields2, connection_type = "s3", connection_options = {"path":"s3://datalake-poc-data/feeds/fdic/net_charge_offs_1_4_family_residential/clean/orc", "partitionKeys": ["report_date"]}, format = "orc", transformation_ctx = "outputfile4")
